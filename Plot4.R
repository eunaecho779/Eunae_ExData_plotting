...
#first plot
plot(janfeb$timestamp, janfeb$Global_active_power, type="l", xlab="", ylab="Global Active Power")

#second plot
plot(janfeb$timestamp, janfeb$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
#fourth plot
plot(janfeb$timestamp, janfeb$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
